  ...
  return (
    ...
    >
      ...
      {open ? (
        <span
          role="tooltip"
          className="absolute bottom-full left-1/2 z-40 mb-2 w-64 -translate-x-1/2 animate-pop border border-border/70 bg-popover px-3 py-2 text-left text-[0.7rem] leading-5 font-normal text-popover-foreground normal-case shadow-[0_20px_60px_-30px_rgba(15,23,42,0.5)] ring-1 ring-foreground/10"
        >
          {label}
